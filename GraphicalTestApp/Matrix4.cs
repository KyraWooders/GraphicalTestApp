...
namespace GraphicalTestApp
{
    class Matrix4
    {
        ...
        public static Matrix4 indentity = new Matrix4();
        ...
        //Returns the transpose of the Matrix4
        ...
        public static Matrix4 operator *(Matrix4 lhs, Matrix4 rhs)
        {
            return new Matrix4(
                ...
                lhs.m21 * rhs.m24 + lhs.m22 * rhs.m24 + lhs.m23 * rhs.m34 + lhs.m24 * rhs.m44,
        ...
        public static Vector4 operator *(Matrix4 lhs, Vector4 rhs)
        {
            return new Vector4(
                ...
                lhs.m31 * rhs.x + lhs.m32 * rhs.y + lhs.m33 * rhs.z + lhs.m44 * rhs.w
                );
        }
